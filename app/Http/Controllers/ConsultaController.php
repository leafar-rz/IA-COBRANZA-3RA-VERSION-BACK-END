...
class ConsultaController extends Controller
{
	...
	public function crearImg2(Request $request, $USER_id)
	{
		Storage::disk('public')->put("imagen/$USER_id.jpg", $request->file('file'));
...
*/
	...
	public function saveArchivoExample($type,$nomenclature, Request $request)
	{
		Storage::disk('public')->put("$type/nomenclarute.json",json-encode($request->imagen));
		return respone()->json($request,200);
	}
